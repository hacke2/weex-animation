<template>
    <div class="wrap">
        ...
        <select-animation :animations="animations" v-if="platform === 'Web'" @change="e => setAnimation(e.target.value)"></select-animation>
...
<script>
  import SelectAnimation from './SelectAnimation.vue';

  import * as animation from './index.js';
